...
e.preventDefault(); // prevent the form from performing its default behaviour (being submitted)
...
if(isNaN(value) || value <= 0 || value > 9){
  ...
  tempText = tempText.map(function(item){ // map the array to access each item from the array
...
//inputs always return a string, to fix it use parseInt
// strings are black, numbers are blue in the console